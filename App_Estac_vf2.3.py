...
def controlPrecio(precio):
    while isinstance(precio, float)==False:
        try:
            ...
            print("Debe ingresar un número entero o con comas")
            precio = input("->Precio: ")
...
def ingresarVehiculo(estacN):
    ...
    torre = controlEntero(input("- Ingrese la Torre: "))
...
def eliminarVehiTorre(estacN):
    ...
    torre = controlEntero(input("-> Indique la Torre: "))
...
while (finDia):
    ...
    opcionMenu = controlEntero(input("\n\r-> Digite una opción: "))
    print("")
    #pausa()
    borrarPantalla()
