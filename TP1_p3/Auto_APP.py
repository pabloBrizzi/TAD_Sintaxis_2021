...
cargarAuto(auto, pat, km, marca, mod, prec)
...
cargarAuto(auto1, pat1, km1, marc1, mod1, prec1)

print(verPat(auto1), " | ",verKm(auto1), " | ", verMarca(auto1), " | ", verModelo(auto1), " | ", verPrecio(auto1), "\n\r")
...
cargarAuto(auto2, pat2, km2, marc2, mod2, prec2)

#Comparo cuál es el de menor precio e imprimo sus datos
if(verPrecio(auto1)<verPrecio(auto2)):
    print(verPat(auto1), " | ", verKm(auto1), " | ", verMarca(auto1), " | ", verModelo(auto1), " | ", verPrecio(auto1))
else:
    print(verPat(auto2), " | ", verKm(auto2), " | ", verMarca(auto2), " | ", verModelo(auto2), " | ", verPrecio(auto2))
